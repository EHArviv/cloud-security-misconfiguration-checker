...
The project includes demo AWS-style configuration files inside the sample_configs folder.

These files are intentionally safe and do not contain real AWS account IDs, ARNs, access keys, secrets, or production data.
...
These files demonstrate what the tool can generate without exposing real cloud data.
